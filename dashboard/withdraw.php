...
if(isset($_POST['actwithdraw'])){
    $atearnings = $_POST['atearnings'];
    $afearnings = $_POST['afearnings'];
    $fburl = $_POST['fburl'];
    $acct_number = $_POST['act_num'];
    $acct_name = $_POST['act_name'];
    $bankcode = $_POST['bank'];

    $insert_query = "INSERT INTO withdraw (full_name, account_name, account_number, bank_name, bank_code, fburl, activity, affiliate) VALUE('$fname', '$acct_name', '$acct_number', 0, '$bankcode', '$fburl', '$atearnings', '$af_earnings')";
...
if(isset($_POST['withdraw'])) {
    ...
    if($eatearnings > 1000){
        $tot_earnings = $eafearnings + ($eatearnings - 800);
    }else{
        if($eatearnings == 0){
...
//echo $day;
echo '<br>';
// if($date == '15' && ($time == $timefrom || $time <= $timeto)){
    if($af_earnings >= 4000){
        echo "<div>";
    ...
    echo "<br>";
    echo "<labe>Acivity Earnings: </labe>";
    echo "<input class='text-left' type=\"text\" id='eatearn' name='eatearnings' value='0' readonly>";
    echo "<br>";
...
if($day == 'Thursday' && ($time == $timefrom || $time <= $timeto)){


    if($af_earnings >= 2000 && $at_earnings > 1000){

        // $eat_earnings = floor($at_earnings * 0.50);
        if(($af_earnings + $at_earnings) >= 5000){
    ...
    echo "</div>";
    echo "<div class=\"col-md-6\">";
    echo "<div class=\"text-center\"> include '../adsense/ressquare.php'</div>";
    echo "<div class=\"text-left pspace\" style=\"background-color: #ffffff;\">";
    echo "<form method='post' action=''>";
    echo "<div class='text-center hhkey' styele='font-weight: bold;'>$message</div>";
    echo "<h4><b>AVAILABLE EARNINGS </b></h4>";
    ...
    echo "<br>";
    echo "<labe>Facebook Profile URL: </labe>";
    echo "<input class='text-left' type=\"text\" name='fburl' value='' required>";
    echo "<br>";
    echo "<h4><b>BANK DETAILS</b></h4>";
    echo "<labe><b>Account Number: <b></b></labe>";
    echo "<input class='text-left' type=\"text\" id='account_num' name='act_num' required>";
...
//    echo "<input class='text-left' type='text' id='result' name='bank_name' placeholder='' required>";
 ...
 if($date == 30){
     if($af_earnings <= 1000 && $at_earnings >= 7000){
        echo "<div>";
        echo "<div class=\"container\" style=\"\">";
        echo "<div class=\"row\">";
        echo "<div class=\"col-md-3\">";
        ...
        echo "<form method='post' action=''>";
        echo "<div class='text-center hhkey' styele='font-weight: bold;'>$message</div>";
        // echo "<h4><b>MY EARNINGS </b></h4>";
        echo "<labe><b>My Earnings: <b></b></labe>";
        echo "<input class='text-left' type=\"text\" name='eatearnings' value='$at_earnings' required>";
        echo "<br>";
        echo "<input class='text-left' type=\"text\" id='afearn' name='eafearnings' value='$af_earnings' readonly>";
        echo "<br>";
        echo "<labe>Facebook Profile URL: </labe>";
