...
//                            $posttitle = mysqli_set_charset($post_title, 'utf8');
                        ...
                        <div class="author vcard inline-items">
                            <div class="text-left author-date"><a href="../<?php echo $post_name ?>" style="color: #eb5d23;"><?php echo "<img src='$postimg'>" ?><br><strong><span style="text-decoration: none;"><?php echo $post_title ?></span></strong></a><br>
